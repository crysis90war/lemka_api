...
urlpatterns = [
    ...
    path('mensurations/<int:ref_user_mensuration_id>/mesures/', UserMesureListApiView.as_view()),
    path('mensurations/<int:ref_user_mensuration_id>/mesures/<int:pk>/', UserMesureRUApiView.as_view()),
